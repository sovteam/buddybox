...
public class SongFoundTest extends ModelTest {
    ...
    public void songFoundDispatched_modelAddsNewSong() {
        ...
        Song newSong = new Song(null, hash, "Jamming", "Bob Marley", "Legend", "Reggae", 213000, "/bob/legend/jamming.mp3" , 8235L , 1L,false, false, 1L);
    ...
    public void songFoundDispatched_modelUpdatesOldSong() {
        ...
        Song newSong = new Song(null, hash, "Jamming it!", "Bob", "I am Legend", "Classic", 42, "/bobby/jamming-it.mp3" , 133L , 2L,false, false, 1L);
        dispatch(new SongFound(newSong));
