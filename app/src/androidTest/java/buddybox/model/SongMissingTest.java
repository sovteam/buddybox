...
public class SongMissingTest extends ModelTest {
    ...
    public void songMissingDispatched_modelRemovesSongAndArtist() {
        ...
        Song song = new Song(null, hash, "Jamming", "Bob Marley", "Legend", "Reggae", 213000, "/bob/legend/jamming.mp3" , 8235L , 1L,false, false, 1L);
    ...
    public void songMissingDispatched_modelRemovesOnlySong() {
        ...
        Song song1 = new Song(null, hash1, "Jamming", "Bob Marley", "Legend", "Reggae", 213000, "/bob/legend/jamming.mp3" , 8235L , 1L,false, false, 1L);
        ...
        Song song2 = new Song(null, hash2, "Is this love", "Bob Marley", "Legend", "Reggae", 214000, "/bob/legend/is this love.mp3" , 6789L , 2L,false, false, 1L);
